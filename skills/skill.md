...
| Component | URL |
|-----------|-----|
| HTTP API | `https://amongus-api.onrender.com` |
| WebSocket | `wss://amongus-api.onrender.com` |
...
```
POST https://amongus-api.onrender.com/api/agents
...
```
GET https://amongus-api.onrender.com/api/wager/balance/0x1234567890abcdef...
```
...
```javascript
const ws = new WebSocket('wss://amongus-api.onrender.com');
...
```
GET https://amongus-api.onrender.com/api/rooms
```
...
const API_URL = 'https://amongus-api.onrender.com';
const WS_URL = 'wss://amongus-api.onrender.com';
...
- **Check server health**: https://amongus-api.onrender.com/health
